...
static const unsigned char amiga_to_fb_scancode[128] = {
    /* 0x00-0x0F: ` 1 2 3 4 5 6 7 8 9 0 - = \ (intl) Numpad0 */
    SC_TILDE, SC_1, SC_2, SC_3, SC_4, SC_5, SC_6, SC_7,
    SC_8, SC_9, SC_0, SC_MINUS, SC_EQUALS, SC_BACKSLASH, 0, SC_KEYPAD0,
    /* 0x10-0x1F: Q W E R T Y U I O P [ ] Numpad1 Numpad2 Numpad3 Numpad4 */
    SC_Q, SC_W, SC_E, SC_R, SC_T, SC_Y, SC_U, SC_I,
    SC_O, SC_P, SC_LEFTBRACKET, SC_RIGHTBRACKET, SC_KEYPAD1, SC_KEYPAD2, SC_KEYPAD3, SC_KEYPAD4,
    /* 0x20-0x2F: A S D F G H J K L ; ' (intl) x Numpad5 Numpad6 Numpad7 */
    SC_A, SC_S, SC_D, SC_F, SC_G, SC_H, SC_J, SC_K,
    SC_L, SC_SEMICOLON, SC_QUOTE, 0, 0, SC_KEYPAD5, SC_KEYPAD6, SC_KEYPAD7,
    /* 0x30-0x3F: (intl) Z X C V B N M , . / x Numpad. Numpad8 Numpad9 */
    0, SC_Z, SC_X, SC_C, SC_V, SC_B, SC_N, SC_M,
    SC_COMMA, SC_PERIOD, SC_SLASH, 0, SC_KEYPADDOT, SC_KEYPAD8, SC_KEYPAD9, 0,
    /* 0x40-0x4F: Space BS Tab NumpadEnter Return Esc Del x x x Numpad- x Up Down Right Left */
    SC_SPACE, SC_BACKSPACE, SC_TAB, SC_KEYPADENTER, SC_ENTER, SC_ESCAPE, SC_DELETE, 0,
    0, 0, SC_KEYPADMINUS, 0, SC_UP, SC_DOWN, SC_RIGHT, SC_LEFT,
    /* 0x50-0x5F: F1-F10 Numpad( Numpad) Numpad/ Numpad* Numpad+ Help */
    SC_F1, SC_F2, SC_F3, SC_F4, SC_F5, SC_F6, SC_F7, SC_F8,
    SC_F9, SC_F10, 0, 0, SC_KEYPADDIVIDE, SC_KEYPADMULTIPLY, SC_KEYPADPLUS, 0,
...
static void driver_update(void) {
    ...
    /* Allocate/reallocate temp bitmap if needed (full screen size for WritePixelArray8) */
