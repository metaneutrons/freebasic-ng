...
_start:
    ...
    | Build argc/argv from saved command line
    | For AmigaOS, pass argc=1, argv=&cmdline_ptr (minimal)
    | The FB runtime uses fb_Init() which reads _cmdline/_cmdlen directly
    pea     _argv_table
    pea     1
    jsr     _main
    addq.l  #8,sp
