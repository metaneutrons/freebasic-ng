...
int32 main( int32 __FB_ARGC__$0, char** __FB_ARGV__$0 )
{
	...
	label$1576:;
	{
		...
		fb_StrAssign( (void*)&TMP$871$1, -1ll, (void*)((uint8*)&FBC$ + 3298ll), 261ll, 0 );
		FBADDINCLUDEPATH( &TMP$871$1 );
		fb_StrAssign( (void*)((uint8*)&FBC$ + 3298ll), 261ll, (void*)&TMP$871$1, -1ll, 0 );
		fb_StrDelete( (FBSTRING*)&TMP$871$1 );
		...
		if( *(int64*)((uint8*)&FBC$ + 136ll) < 0ll) goto label$1582;
		{
			{
				int64 TMP$872$3;
				TMP$872$3 = *(int64*)((uint8*)&FBC$ + 136ll);
				if( TMP$872$3 != 0ll) goto label$1584;
				label$1585:;
				{
				...
				goto label$1583;
				label$1584:;
				if( TMP$872$3 != 1ll) goto label$1586;
				label$1587:;
				{
				...
				goto label$1583;
				label$1586:;
				if( TMP$872$3 != 2ll) goto label$1588;
				label$1589:;
				{
				...
				goto label$1583;
				label$1588:;
				if( TMP$872$3 != 3ll) goto label$1592;
				label$1593:;
				{
				...
				goto label$1583;
				label$1592:;
				if( TMP$872$3 != 4ll) goto label$1594;
				label$1595:;
				{
				...
				goto label$1583;
				label$1594:;
				if( TMP$872$3 != 5ll) goto label$1596;
				label$1597:;
				{
...
static int64 HLINKFILES( void )
{
	...
	label$274:;
	{
		...
		goto label$282;
		label$283:;
		static const void* tmp$875[13ll] = {
			&&label$284,
			&&label$284,
			&&label$293,
			&&label$293,
				...
				{
					{
						...
						goto label$382;
						label$383:;
						static const void* tmp$878[3ll] = {
							&&label$384,
							&&label$385,
							&&label$384,
						};
						if( (TMP$240$6 - 9ull) > 2ull ) goto label$385;
						goto *tmp$878[TMP$240$6 - 9ull];
						label$382:;
					}
				}
				label$376:;
...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$570:;
	{
		...
		label$726:;
		{
			...
			if( (((int64)-(OS$3 != 2ll) | (int64)-(CPUTYPE$3 != 19ll)) | IS_GNU_TRIPLET$3) == 0ll) goto label$730;
			{
				FBSTRING TMP$400$4;
		...
		goto label$572;
		label$573:;
		static const void* tmp$884[74ll] = {
			&&label$574,
			&&label$575,
			&&label$578,
			&&label$585,
...
static int64 PARSEOPTION( char* OPT$1 )
{
	...
	label$804:;
	{
		...
		goto label$806;
		label$807:;
		static const void* tmp$885[78ll] = {
			&&label$981,
			&&label$806,
			&&label$806,
			&&label$806,
	...
	label$1267:;
	{
		...
		label$1271:;
		{
			...
			fb_StrConcatAssign( (void*)&LN$1, -1ll, (void*)"-fno-strict-aliasing ", 22ll, 0 );
			{
				...
				goto label$1304;
				label$1305:;
				static const void* tmp$889[1ll] = {
					&&label$1306,
				};
				if( TMP$628$4 > 0ull ) goto label$1304;
				goto *tmp$889[TMP$628$4 - 0ull];
				label$1304:;
			}
			int64 vr$73 = FBGETOPTION( 3ll );
...
static void HADDDEFAULTLIBS( void )
{
	...
	if( vr$15 == 0ll) goto label$1485;
	{
		...
		fb_StrDelete( (FBSTRING*)&TMP$710$2 );
		{
			...
			{
				FBSTRING TMP$715$4;
				__builtin_memset( &TMP$715$4, 0, 24ll );
				fb_StrAssign( (void*)&TMP$715$4, -1ll, (void*)"/usr/X11R6/lib", 15ll, 0 );
				FBCADDDEFLIBPATH( &TMP$715$4 );
				fb_StrDelete( (FBSTRING*)&TMP$715$4 );
	...
	label$1484:;
	{
		...
		label$1505:;
		{
			...
			if( ((int64)-(vr$32 > 0ll) | (int64)-(vr$35 > 0ll)) == 0ll) goto label$1507;
			{
			...
			if( ((int64)-(vr$39 > 0ll) | (int64)-(vr$42 > 0ll)) == 0ll) goto label$1509;
			{
		...
		label$1513:;
		{
			...
			if( ((int64)-(vr$46 > 0ll) | (int64)-(vr$49 > 0ll)) == 0ll) goto label$1515;
			{
				FBCADDDEFLIB( (char*)"gcc_eh" );
			}
			label$1515:;
		...
		goto label$1491;
		label$1492:;
		static const void* tmp$891[17ll] = {
			&&label$1513,
			&&label$1493,
			&&label$1505,
			&&label$1512,
		...
		if( TMP$721$2 > 16ull ) goto label$1491;
		goto *tmp$891[TMP$721$2 - 0ull];
		label$1491:;
	}
	label$1481:;
}
...
static void HEXCLUDELIBSFROMLINK( void )
{
	...
	if( I$1 == (struct $11TSTRSETITEM*)0ull) goto label$1524;
	{
		{
			FBSTRING TMP$746$3;
			fb_StrInit( (void*)&TMP$746$3, -1ll, (void*)I$1, -1ll, 0 );
			int32 vr$6 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt0.o", 8ll );
			if( (int64)vr$6 == 0ll) goto label$1527;
			label$1528:;
			int32 vr$9 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt0pic.o", 11ll );
			if( (int64)vr$9 == 0ll) goto label$1527;
			label$1529:;
			int32 vr$12 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt1.o", 8ll );
			if( (int64)vr$12 == 0ll) goto label$1527;
			label$1530:;
			int32 vr$15 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt1pic.o", 11ll );
			if( (int64)vr$15 == 0ll) goto label$1527;
			label$1531:;
			int32 vr$18 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt2.o", 8ll );
			if( (int64)vr$18 == 0ll) goto label$1527;
			label$1532:;
			int32 vr$21 = fb_StrCompare( (void*)&TMP$746$3, -1ll, (void*)"fbrt2pic.o", 11ll );
...
static void HPRINTVERSION( int64 VERBOSE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$864$1, (void*)"FreeBASIC Compiler - Version 1.20.0 (2026-09-11), built for ", 61ll, (void*)vr$3, -1ll );
	__builtin_memset( &TMP$865$1, 0, 24ll );
	FBSTRING* vr$9 = fb_StrConcat( &TMP$865$1, (void*)vr$6, -1ll, (void*)" (", 3ll );
	__builtin_memset( &TMP$866$1, 0, 24ll );
	FBSTRING* vr$12 = fb_StrConcat( &TMP$866$1, (void*)vr$9, -1ll, (void*)vr$2, -1ll );
	__builtin_memset( &TMP$867$1, 0, 24ll );
	FBSTRING* vr$15 = fb_StrConcat( &TMP$867$1, (void*)vr$12, -1ll, (void*)"bit)", 5ll );
	fb_PrintString( 0, (FBSTRING*)vr$15, 1 );
