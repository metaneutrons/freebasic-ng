...
typedef struct $6IRVREG* (*tmp$86)( struct $7ASTNODE* );
...
static tmp$86 AST_LOADCALLBACKS$[45] = { (tmp$86)&ASTLOADNOP, (tmp$86)&ASTLOADLOAD, (tmp$86)&ASTLOADASSIGN, (tmp$86)&ASTLOADBOP, (tmp$86)&ASTLOADUOP, (tmp$86)&ASTLOADCONV, (tmp$86)&ASTLOADADDROF, (tmp$86)&ASTLOADBRANCH, (tmp$86)&ASTLOADJMPTB, (tmp$86)&ASTLOADCALL, (tmp$86)&ASTLOADCALLCTOR, (tmp$86)&ASTLOADSTACK, (tmp$86)&ASTLOADMEM, (tmp$86)&ASTLOADLOOP, (tmp$86)0ull, (tmp$86)&ASTLOADLINK, (tmp$86)&ASTLOADCONST, (tmp$86)&ASTLOADVAR, (tmp$86)&ASTLOADIDX, (tmp$86)&ASTLOADFIELD, (tmp$86)&ASTLOADDEREF, (tmp$86)&ASTLOADLABEL, (tmp$86)0ull, (tmp$86)&ASTLOADOFFSET, (tmp$86)&ASTLOADDECL, (tmp$86)&ASTLOADNIDXARRAY, (tmp$86)&ASTLOADIIF, (tmp$86)&ASTLOADLIT, (tmp$86)&ASTLOADASM, (tmp$86)0ull, (tmp$86)&ASTLOADDBG, (tmp$86)&ASTLOADBOUNDCHK, (tmp$86)&ASTLOADPTRCHK, (tmp$86)&ASTLOADSCOPEBEGIN, (tmp$86)&ASTLOADSCOPEEND, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)0ull, (tmp$86)&ASTLOADMACRO };
struct $6ASTCTX AST$;
...
struct $7ASTNODE* ASTCLONETREE( struct $7ASTNODE* N$1 )
{
	...
	label$20:;
	{
		$13AST_NODECLASS TMP$199$2;
		TMP$199$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$199$2 != 17ll) goto label$23;
		label$24:;
		{
		...
		goto label$22;
		label$23:;
		if( TMP$199$2 != 9ll) goto label$29;
		label$30:;
		{
		...
		goto label$22;
		label$29:;
		if( TMP$199$2 != 26ll) goto label$31;
		label$32:;
		{
		...
		goto label$22;
		label$31:;
		if( TMP$199$2 != 13ll) goto label$33;
		label$34:;
		{
		...
		goto label$22;
		label$33:;
		if( TMP$199$2 != 36ll) goto label$35;
		label$36:;
		{
		...
		goto label$22;
		label$35:;
		if( TMP$199$2 != 19ll) goto label$37;
		label$38:;
		{
...
struct $7ASTNODE* ASTGETEFFECTIVENODE( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)N$1 != 15ll) goto label$44;
	{
		{
			int64 TMP$200$3;
			TMP$200$3 = *(int64*)((uint8*)N$1 + 40ll);
			if( TMP$200$3 != 1ll) goto label$46;
			label$47:;
			{
			...
			goto label$45;
			label$46:;
			if( TMP$200$3 != 2ll) goto label$48;
			label$49:;
			{
...
struct $7ASTNODE* ASTREBUILDWITHOUTEFFECTIVEPART( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)N$1 != 15ll) goto label$56;
	{
		...
		{
			int64 TMP$201$3;
			TMP$201$3 = *(int64*)((uint8*)N$1 + 40ll);
			if( TMP$201$3 != 1ll) goto label$58;
			label$59:;
			{
			...
			goto label$57;
			label$58:;
			if( TMP$201$3 != 2ll) goto label$60;
			label$61:;
			{
...
int64 ASTCANTAKEADDROF( struct $7ASTNODE* N$1 )
{
	...
	label$63:;
	{
		...
		label$69:;
		{
			{
				int64 TMP$203$4;
				TMP$203$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$203$4 != 1ll) goto label$71;
				label$72:;
				{
				...
				goto label$70;
				label$71:;
				if( TMP$203$4 != 2ll) goto label$73;
				label$74:;
				{
		...
		goto label$65;
		label$66:;
		static const void* tmp$204[27ll] = {
			&&label$67,
			&&label$76,
			&&label$76,
			&&label$76,
		...
		if( (TMP$202$2 - 10ull) > 26ull ) goto label$76;
		goto *tmp$204[TMP$202$2 - 10ull];
		label$65:;
	}
	label$64:;
	return fb$result$1;
...
struct $7ASTNODE* ASTMAKEREF( struct $7ASTNODE** EXPR$1 )
{
	...
	TMP$205$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*EXPR$1 + 24ll) + 192ll) > 0ll);
	goto label$88;
	label$79:;
	TMP$205$1 = 0ll;
	label$88:;
	if( TMP$205$1 == 0ll) goto label$81;
	{
	...
	if( *(int64*)*EXPR$1 != 9ll) goto label$83;
	{
		{
			int64 TMP$206$3;
			TMP$206$3 = *(int64*)((uint8*)*EXPR$1 + 8ll) & 511ll;
			if( TMP$206$3 == 17ll) goto label$86;
			label$87:;
			if( TMP$206$3 != 7ll) goto label$85;
			label$86:;
			{
...
struct $7ASTNODE* ASTREMSIDEFX( struct $7ASTNODE** N$1 )
{
	...
	*N$1 = vr$2;
	{
		uint64 TMP$207$2;
		TMP$207$2 = (uint64)(*(int64*)((uint8*)*N$1 + 8ll) & 511ll);
		goto label$92;
		label$93:;
		{
		...
		goto label$91;
		label$92:;
		static const void* tmp$208[17ll] = {
			&&label$93,
			&&label$94,
			&&label$94,
			&&label$93,
		...
		if( (TMP$207$2 - 4ull) > 16ull ) goto label$94;
		goto *tmp$208[TMP$207$2 - 4ull];
		label$91:;
	}
	label$90:;
	return fb$result$1;
...
int64 ASTGETINVERSELOGOP( int64 OP$1 )
{
	...
	label$117:;
	{
		...
		if( (TMP$209$2 - 45ull) > 5ull ) goto label$119;
		goto *tmp$210[TMP$209$2 - 45ull];
		label$119:;
	}
	fb$result$1 = OP$1;
	label$118:;
...
struct $6IRVREG* ASTLOAD( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$1 = (*(tmp$86*)((int64)(tmp$86*)AST_LOADCALLBACKS$ + (*(int64*)N$1 << (3ll & 63ll))))( N$1 );
		fb$result$1 = vr$1;
	}
	label$130:;
	label$129:;
