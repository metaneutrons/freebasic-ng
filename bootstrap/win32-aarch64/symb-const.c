...
struct $8FBSYMBOL* SYMBREUSEORADDCONST( char* ID$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, union $7FBVALUE* VALUE$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0ull) goto label$17;
	{
		...
		if( ((int64)-(*(int64*)((uint8*)SYM$1 + 56ll) == DTYPE$1) & (int64)-(*(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll) == SUBTYPE$1)) == 0ll) goto label$21;
		{
			{
				int64 TMP$86$4;
				TMP$86$4 = DTYPE$1 & 511ll;
				if( TMP$86$4 == 17ll) goto label$24;
				label$25:;
				if( TMP$86$4 == 4ll) goto label$24;
				label$26:;
				if( TMP$86$4 != 7ll) goto label$23;
				label$24:;
				{
				...
				goto label$22;
				label$23:;
				if( TMP$86$4 == 15ll) goto label$28;
				label$29:;
				if( TMP$86$4 != 16ll) goto label$27;
				label$28:;
				{
...
struct $8FBSYMBOL* SYMBALLOCFLOATCONST( double VALUE$1, int64 DTYPE$1 )
{
	...
	fb_StrAssign( (void*)&TMP$90$1, -1ll, (void*)vr$2, -1ll, 0 );
	struct $8FBSYMBOL* vr$5 = HALLOCINTORFLOATCONST( &TMP$90$1, DTYPE$1 );
	fb$result$1 = vr$5;
...
struct $8FBSYMBOL* SYMBALLOCINTCONST( int64 VALUE$1, int64 DTYPE$1 )
{
	...
	goto label$46;
	label$43:;
	TMP$92$1 = DTYPE$1 & 31ll;
	label$46:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$92$1 * 56ll)) + 8ll) != 8ll) goto label$45;
	{
...
struct $8FBSYMBOL* SYMBALLOCSTRCONST( char* SNAME$1, int64 STRLENGTH$1 )
{
	...
	if( INTERNALSTRLEN$1 > 122ll) goto label$52;
	{
		...
		FBSTRING* vr$4 = fb_StrConcat( &TMP$95$2, (void*)ID$1, 134ll, (void*)SNAME$1, 0ll );
	...
	struct $8FBSYMBOL* vr$10 = SYMBADDVAR( (char*)ID$1, (char*)ID_ALIAS$1, 4ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 3073ll, 137ll );
	S$1 = vr$10;
...
struct $8FBSYMBOL* SYMBALLOCWSTRCONST( uint16* SNAME$1, int64 STRLENGTH$1 )
{
	...
	if( (INTERNALSTRLEN$1 << (3ll & 63ll)) > 122ll) goto label$60;
	{
		...
		char* vr$3 = HESCAPEW( (uint16*)SNAME$1, 0ll );
		__builtin_memset( &TMP$98$2, 0, 24ll );
		FBSTRING* vr$6 = fb_StrConcat( &TMP$98$2, (void*)ID$1, 134ll, (void*)vr$3, 0ll );
	...
	struct $8FBSYMBOL* vr$13 = SYMBADDVAR( (char*)ID$1, (char*)ID_ALIAS$1, 7ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$96$1, 3073ll, 137ll );
	S$1 = vr$13;
...
FBSTRING* SYMBGETCONSTVALUEASSTR( struct $8FBSYMBOL* S$1 )
{
	...
	{
		int64 TMP$99$2;
		TMP$99$2 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
		if( TMP$99$2 == 17ll) goto label$71;
		label$72:;
		if( TMP$99$2 == 18ll) goto label$71;
		label$73:;
		if( TMP$99$2 != 4ll) goto label$70;
		label$71:;
		{
		...
		goto label$69;
		label$70:;
		if( TMP$99$2 != 16ll) goto label$74;
		label$75:;
		{
		...
		goto label$69;
		label$74:;
		if( TMP$99$2 != 15ll) goto label$76;
		label$77:;
		{
		...
		label$76:;
		{
			...
			goto label$82;
			label$79:;
			TMP$100$3 = *(int64*)((uint8*)S$1 + 56ll) & 31ll;
			label$82:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) + 16ll) == 0ll) goto label$81;
			{
...
char* SYMBGETCONSTSTRASSTR( struct $8FBSYMBOL* S$1 )
{
		...
		if( vr$7 == TEXTLEN$2) goto label$90;
		{
			DZSTRCONCATASSIGN( &RES$1, (char*)"!\x22" );
			{
				...
				label$94:;
				{
					...
					FBSTRING* vr$15 = fb_StrConcat( &TMP$106$5, (void*)"\x5Cx", 3ll, (void*)vr$12, -1ll );
					fb_StrAssign( (void*)&TMP$107$5, -1ll, (void*)vr$15, -1ll, 0 );
					DZSTRCONCATASSIGN( &RES$1, (char*)*(char**)&TMP$107$5 );
					fb_StrDelete( (FBSTRING*)&TMP$107$5 );
				}
				label$92:;
				I$4 = I$4 + 1ll;
				label$91:;
				if( I$4 <= TMP$104$4) goto label$94;
				label$93:;
			}
		}
		goto label$89;
	...
	label$88:;
	{
		...
		DZSTRCONCATASSIGN( &RES$1, (char*)"!\x22" );
		{
			...
			I$3 = 0ll;
			int64 TMP$110$3;
			TMP$110$3 = TEXTLEN$2 + -1ll;
			goto label$95;
			label$98:;
			{
				if( (int64)(uint32)*(uint16*)((uint8*)TEXT$2 + (I$3 << (1ll & 63ll))) < 65536ll) goto label$100;
				{
					FBSTRING TMP$112$5;
					FBSTRING TMP$113$5;
					__builtin_memset( &TMP$113$5, 0, 24ll );
					FBSTRING* vr$32 = fb_HEXEx_i( (uint32)*(uint16*)((uint8*)TEXT$2 + (I$3 << (1ll & 63ll))), 8 );
					__builtin_memset( &TMP$112$5, 0, 24ll );
					FBSTRING* vr$35 = fb_StrConcat( &TMP$112$5, (void*)"\x5CU", 3ll, (void*)vr$32, -1ll );
					fb_StrAssign( (void*)&TMP$113$5, -1ll, (void*)vr$35, -1ll, 0 );
					DZSTRCONCATASSIGN( &RES$1, (char*)*(char**)&TMP$113$5 );
				...
				label$100:;
				{
					...
					FBSTRING* vr$42 = fb_HEXEx_i( (uint32)*(uint16*)((uint8*)TEXT$2 + (I$3 << (1ll & 63ll))), 4 );
					__builtin_memset( &TMP$115$5, 0, 24ll );
					FBSTRING* vr$45 = fb_StrConcat( &TMP$115$5, (void*)"\x5Cu", 3ll, (void*)vr$42, -1ll );
					fb_StrAssign( (void*)&TMP$116$5, -1ll, (void*)vr$45, -1ll, 0 );
					DZSTRCONCATASSIGN( &RES$1, (char*)*(char**)&TMP$116$5 );
			...
			I$3 = I$3 + 1ll;
			label$95:;
			if( I$3 <= TMP$110$3) goto label$98;
			label$97:;
		}
		DZSTRCONCATASSIGN( &RES$1, (char*)"\x22" );
	}
...
uint16* SYMBGETCONSTSTRASWSTR( struct $8FBSYMBOL* S$1 )
{
	...
	if( (*(int64*)((uint8*)S$1 + 56ll) & 511ll) != 7ll) goto label$104;
	{
		...
		{
			uint16* TMP$117$3;
			uint16* vr$8 = fb_StrToWstr( (char*)"!\x22" );
			TMP$117$3 = vr$8;
			DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$117$3 );
			fb_WstrDelete( (uint16*)TMP$117$3 );
			{
				int64 I$4;
				I$4 = 0ll;
				int64 TMP$118$4;
				TMP$118$4 = TEXTLEN$2 + -1ll;
				goto label$107;
				label$110:;
				{
					if( (int64)(uint32)*(uint16*)((uint8*)TEXT$2 + (I$4 << (1ll & 63ll))) < 65536ll) goto label$112;
					{
						FBSTRING TMP$119$6;
						FBSTRING TMP$120$6;
						uint16* TMP$121$6;
						__builtin_memset( &TMP$120$6, 0, 24ll );
						FBSTRING* vr$18 = fb_HEXEx_i( (uint32)*(uint16*)((uint8*)TEXT$2 + (I$4 << (1ll & 63ll))), 8 );
						__builtin_memset( &TMP$119$6, 0, 24ll );
						FBSTRING* vr$21 = fb_StrConcat( &TMP$119$6, (void*)"\x5CU", 3ll, (void*)vr$18, -1ll );
						fb_StrAssign( (void*)&TMP$120$6, -1ll, (void*)vr$21, -1ll, 0 );
						uint16* vr$23 = fb_StrToWstr( (char*)*(char**)&TMP$120$6 );
						TMP$121$6 = vr$23;
						DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$121$6 );
						fb_WstrDelete( (uint16*)TMP$121$6 );
						fb_StrDelete( (FBSTRING*)&TMP$120$6 );
					}
					goto label$111;
					label$112:;
					{
						...
						FBSTRING TMP$123$6;
						uint16* TMP$124$6;
						__builtin_memset( &TMP$123$6, 0, 24ll );
						FBSTRING* vr$29 = fb_HEXEx_i( (uint32)*(uint16*)((uint8*)TEXT$2 + (I$4 << (1ll & 63ll))), 4 );
						__builtin_memset( &TMP$122$6, 0, 24ll );
						FBSTRING* vr$32 = fb_StrConcat( &TMP$122$6, (void*)"\x5Cu", 3ll, (void*)vr$29, -1ll );
						fb_StrAssign( (void*)&TMP$123$6, -1ll, (void*)vr$32, -1ll, 0 );
						uint16* vr$34 = fb_StrToWstr( (char*)*(char**)&TMP$123$6 );
						TMP$124$6 = vr$34;
						DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$124$6 );
						fb_WstrDelete( (uint16*)TMP$124$6 );
						fb_StrDelete( (FBSTRING*)&TMP$123$6 );
					}
					label$111:;
				}
				label$108:;
				I$4 = I$4 + 1ll;
				label$107:;
				if( I$4 <= TMP$118$4) goto label$110;
				label$109:;
			}
		}
		goto label$105;
		...
		{
			uint16* TMP$125$3;
			uint16* vr$37 = fb_StrToWstr( (char*)"$\x22" );
			TMP$125$3 = vr$37;
			DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$125$3 );
			fb_WstrDelete( (uint16*)TMP$125$3 );
			DWSTRCONCATASSIGN( &RES$1, (uint16*)TEXT$2 );
		}
		label$105:;
		uint16* vr$38 = fb_StrToWstr( (char*)"\x22" );
		TMP$126$2 = vr$38;
		DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$126$2 );
	...
	label$104:;
	{
		...
		__builtin_memset( &TEXTLEN$2, 0, 8ll );
		char* TEXT$2;
		char* vr$42 = HUNESCAPE( *(char**)((uint8*)S$1 + 96ll), &TEXTLEN$2 );
		TEXT$2 = vr$42;
		uint16* vr$43 = fb_StrToWstr( (char*)"!\x22" );
		TMP$127$2 = vr$43;
		DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$127$2 );
		fb_WstrDelete( (uint16*)TMP$127$2 );
		{
			int64 I$3;
			I$3 = 0ll;
			int64 TMP$128$3;
			TMP$128$3 = TEXTLEN$2 + -1ll;
			goto label$113;
			label$116:;
			{
				if( (int64)(uint32)*(uint8*)((uint8*)TEXT$2 + I$3) < 65536ll) goto label$118;
				{
					...
					FBSTRING* vr$51 = fb_HEXEx_i( (uint32)*(uint8*)((uint8*)TEXT$2 + I$3), 8 );
					__builtin_memset( &TMP$129$5, 0, 24ll );
					FBSTRING* vr$54 = fb_StrConcat( &TMP$129$5, (void*)"\x5CU", 3ll, (void*)vr$51, -1ll );
					fb_StrAssign( (void*)&TMP$130$5, -1ll, (void*)vr$54, -1ll, 0 );
					uint16* vr$56 = fb_StrToWstr( (char*)*(char**)&TMP$130$5 );
					TMP$131$5 = vr$56;
					DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$131$5 );
					fb_WstrDelete( (uint16*)TMP$131$5 );
				...
				label$118:;
				{
					...
					FBSTRING* vr$61 = fb_HEXEx_i( (uint32)*(uint8*)((uint8*)TEXT$2 + I$3), 4 );
					__builtin_memset( &TMP$132$5, 0, 24ll );
					FBSTRING* vr$64 = fb_StrConcat( &TMP$132$5, (void*)"\x5Cu", 3ll, (void*)vr$61, -1ll );
					fb_StrAssign( (void*)&TMP$133$5, -1ll, (void*)vr$64, -1ll, 0 );
					uint16* vr$66 = fb_StrToWstr( (char*)*(char**)&TMP$133$5 );
					TMP$134$5 = vr$66;
					DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$134$5 );
					fb_WstrDelete( (uint16*)TMP$134$5 );
					fb_StrDelete( (FBSTRING*)&TMP$133$5 );
				}
				label$117:;
			}
			label$114:;
			I$3 = I$3 + 1ll;
			label$113:;
			if( I$3 <= TMP$128$3) goto label$116;
			label$115:;
		}
		uint16* vr$69 = fb_StrToWstr( (char*)"\x22" );
		TMP$135$2 = vr$69;
		DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$135$2 );
		fb_WstrDelete( (uint16*)TMP$135$2 );
	}
	label$103:;
...
static struct $8FBSYMBOL* HALLOCINTORFLOATCONST( FBSTRING* SVALUE$1, int64 DTYPE$1 )
{
	...
	struct $8FBARRAY1I10FBARRAYDIME tmp$87$1;
	*(struct $10FBARRAYDIM**)&tmp$87$1 = (struct $10FBARRAYDIM*)DTB$1;
	*(struct $10FBARRAYDIM**)((uint8*)&tmp$87$1 + 8ll) = (struct $10FBARRAYDIM*)DTB$1;
	*(int64*)((uint8*)&tmp$87$1 + 16ll) = 16ll;
	*(int64*)((uint8*)&tmp$87$1 + 24ll) = 16ll;
	*(int64*)((uint8*)&tmp$87$1 + 32ll) = 1ll;
	*(int64*)((uint8*)&tmp$87$1 + 40ll) = 49ll;
	*(int64*)((uint8*)&tmp$87$1 + 48ll) = 1ll;
	*(int64*)((uint8*)&tmp$87$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$87$1 + 64ll) = 0ll;
	fb$result$1 = (struct $8FBSYMBOL*)0ull;
	fb_StrAssign( (void*)ID$1, 134ll, (void*)"{fbnc}", 7ll, 0 );
	__builtin_memset( &TMP$89$1, 0, 24ll );
	FBSTRING* vr$6 = fb_StrConcat( &TMP$89$1, (void*)ID$1, 134ll, (void*)SVALUE$1, -1ll );
	fb_StrAssign( (void*)ID$1, 134ll, (void*)vr$6, -1ll, 0 );
	struct $8FBSYMBOL* S$1;
	...
	label$37:;
	char* vr$10 = SYMBUNIQUEID( (boolean)0ll );
	struct $8FBSYMBOL* vr$11 = SYMBADDVAR( (char*)ID$1, (char*)vr$10, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$87$1, 3073ll, 137ll );
	S$1 = vr$11;
