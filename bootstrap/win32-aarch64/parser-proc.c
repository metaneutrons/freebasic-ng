	...
	*($13FB_PROCATTRIB*)((uint8*)PROC$1 + 16ll) = PATTRIB$1;
	...
	label$585:;
	{
		...
		label$606:;
		{
			...
			{
				if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 16ll) == 8ll) goto label$616;
				{
	...
	if( PROC$1 == (struct $8FBSYMBOL*)0ull) goto label$680;
	{
		...
		if( IS_GLOBAL$2 == 0ll) goto label$682;
		{
			...
			if( ((int64)-(vr$223 > 0ll) & (int64)-(*(struct $8FBSYMBOL**)*(struct $8FBHASHTB**)((uint8*)PROC$1 + 248ll) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll))) == 0ll) goto label$684;
			{
				...
				{
					ERRREPORTWARNEX( 47ll, (char*)ID$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), 1ll, (char*)0ull );
				}
				label$686:;
				label$685:;
			}
	...
	fb$result$1 = 0ll;
	{
		...
		label$104:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1448ll) & 524288ll) == 0ll) goto label$106;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2096ll) <= 0ll) goto label$110;
					{
