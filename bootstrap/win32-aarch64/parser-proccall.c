...
int64 HFORWARDCALL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$323:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1448ll) & 524288ll) == 0ll) goto label$325;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2096ll) <= 0ll) goto label$329;
					{
	...
	if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 16ll) == 2147483648ll) goto label$332;
	{
		ERRREPORT( 17ll, 0ll, (char*)0ull );
	}
	label$332:;
...
static int64 HPROCCALLORASSIGN_QB( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$233:;
		{
			int64 vr$4 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll), 0ll );
			fb$result$1 = vr$4;
			goto label$230;
		}
		goto label$231;
		label$234:;
		{
			...
			{
				int64 vr$8 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll), 0ll );
				fb$result$1 = vr$8;
				goto label$230;
			}
			label$236:;
			...
			label$237:;
			LEXSKIPTOKEN( 2048ll );
			if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull) goto label$240;
			{
			...
			label$240:;
			{
				int64 vr$15 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll), -1ll );
				fb$result$1 = vr$15;
				goto label$230;
			}
			label$239:;
