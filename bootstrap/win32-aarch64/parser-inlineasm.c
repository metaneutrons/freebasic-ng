				...
				if( EXPR$1 == (struct $7ASTNODE*)0ull) goto label$96;
				{
					...
					if( LITSYM$5 == (struct $8FBSYMBOL*)0ull) goto label$98;
					{
						...
						label$100:;
						{
							...
							TMP$839$7 = vr$35;
							fb_WstrAssignToA( (void*)TEXT$1, 1025ll, (uint16*)TMP$839$7, 0 );
							fb_WstrDelete( (uint16*)TMP$839$7 );
						}
						label$99:;
...
int64 CASMBLOCK( void )
{
	...
	if( vr$3 == 0ll) goto label$128;
	{
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll) goto label$130;
		{
			...
			{
				struct $7ASTNODE* vr$5 = ASTNEWLIT( *(char**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25080ll) );
				ASTADD( vr$5 );
	...
	label$137:;
	{
		...
		{
			struct $7ASTNODE* vr$11 = ASTNEWDBG( 114ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), *(char**)((uint8*)&ENV$ + 896ll) );
			ASTADD( vr$11 );
		}
		label$141:;
		label$140:;
		...
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll) goto label$143;
		{
			...
			{
				struct $7ASTNODE* vr$13 = ASTNEWLIT( *(char**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25080ll) );
				ASTADD( vr$13 );
				DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25080ll) );
			}
			label$145:;
