...
struct $7ASTNODE* ASTNEWMEM( int64 OP$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int64 BYTES$1, int64 FILLCHAR$1 )
{
	...
	struct $7ASTNODE* N$1;
	uint64 BLKMAXLEN$1;
	int64 vr$1 = (*(tmp$42*)((uint8*)&IR$ + 32ll))( 1ll );
...
struct $7ASTNODE* ASTBUILDNEWOP( $6AST_OP OP$1, struct $8FBSYMBOL* TMP$1, struct $7ASTNODE* ELEMENTSEXPR$1, struct $7ASTNODE* INITEXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 DO_CLEAR$1, struct $7ASTNODE* NEWEXPR$1 )
{
	...
	label$29:;
	{
		...
		if( DO_CLEAR$1 == 0ll) goto label$37;
		{
			...
			label$72:;
			if( TMP$88$3 != 20ll) goto label$39;
			struct $8FBSYMBOL* vr$8 = SYMBGETCOMPOPOVLHEAD( SUBTYPE$1, *($6AST_OP*)(((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 24ll) );
			TMP$89$3 = (int64)-(vr$8 != (struct $8FBSYMBOL*)0ull);
			goto label$73;
			label$39:;
			TMP$89$3 = 0ll;
			label$73:;
			TMP$90$3 = (int64)-(TMP$89$3 != 0ll);
			goto label$71;
			label$40:;
			TMP$90$3 = -1ll;
			label$71:;
			if( TMP$90$3 == 0ll) goto label$42;
			{
				INIT$1 = 4ll;
				ELEMENTSTREECOUNT$1 = ELEMENTSTREECOUNT$1 + 1ll;
			}
	...
	label$56:;
	label$55:;
	struct $7ASTNODE* vr$26 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEu7INTEGER( TMP$1, NEWEXPR$1, 64ll );
	...
	label$61:;
	{
		...
		label$65:;
		{
			...
			struct $7ASTNODE* vr$46 = _Z15ASTTYPEINIFLUSHP7ASTNODES0_u7INTEGERS1_( vr$45, INITEXPR$1, 0ll, 64ll );
			INITEXPR$1 = vr$46;
		}
		goto label$63;
		label$66:;
		...
		if( TMP$91$2 > 4ull ) goto label$70;
		goto *tmp$92[TMP$91$2 - 0ull];
		label$63:;
	}
...
struct $6IRVREG* ASTLOADMEM( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$60*)((uint8*)&IR$ + 296ll))( *(int64*)((uint8*)N$1 + 40ll), V1$1, V2$1, *(int64*)((uint8*)N$1 + 48ll), *(int64*)((uint8*)N$1 + 56ll) );
	}
	label$91:;
	label$90:;
	fb$result$1 = (struct $6IRVREG*)0ull;
