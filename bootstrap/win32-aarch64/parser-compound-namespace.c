...
void CNAMESPACESTMTBEGIN( void )
{
	...
	PALIAS$1 = (char*)0ull;
	{
		...
		if( (TMP$96$2 - 256ull) > 4ull ) goto label$20;
		goto *tmp$98[TMP$96$2 - 256ull];
		label$20:;
	}
	LEVELS$1 = 0ll;
	label$23:;
