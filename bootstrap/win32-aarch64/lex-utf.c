...
void LEXREADUTF8( void )
{
	...
	label$69:;
	*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8648ll) = CHARS$1;
...
static int64 HUTF8TOCHAR( void )
{
	...
	static int64 I$1;
	DST$1 = (uint8*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8664ll);
	CHARS$1 = 0ll;
	label$12:;
...
static int64 HUTF8TOUTF16LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8664ll);
	CHARS$1 = 0ll;
	label$29:;
...
static int64 HUTF8TOUTF32LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8664ll);
	CHARS$1 = 0ll;
	label$48:;
...
static int64 HUTF16LETOUTF16LE( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$88:;
	int32 vr$4 = fb_FileGetWstrLarge( (int32)*(int64*)((uint8*)&ENV$ + 624ll), 0ll, (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8664ll), 8193ll );
	if( (int64)vr$4 != 0ll) goto label$91;
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 624ll) );
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25072ll) = vr$7;
		fb$result$1 = (int64)((uint64)(*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25072ll) - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25056ll)) >> (1ull & 63ll));
	}
	goto label$90;
	label$91:;
	{
...
static int64 HUTF32LETOUTF32LE( void )
{
	...
	if( (int64)vr$4 != 0ll) goto label$185;
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 624ll) );
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25072ll) = vr$7;
		fb$result$1 = (int64)((uint64)(*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25072ll) - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25056ll)) >> (2ull & 63ll));
	}
	goto label$184;
	label$185:;
	{
