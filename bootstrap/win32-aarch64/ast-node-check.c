...
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE* L$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, int64 LINENUM$1, char* FILENAME$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	TMP$96$1 = (int64)-(UB$1 == (struct $7ASTNODE*)0ull);
	goto label$27;
	label$12:;
	TMP$96$1 = 0ll;
	label$27:;
	if( TMP$96$1 == 0ll) goto label$14;
	{
...
struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll) goto label$33;
	{
		...
		LABEL$1 = vr$10;
		struct $6IRVREG* vr$11 = (*(tmp$72*)((uint8*)&IR$ + 456ll))( 8ll, (struct $8FBSYMBOL*)0ull, 0ll );
		(*(tmp$53*)((uint8*)&IR$ + 184ll))( 45ll, VR$1, vr$11, (struct $6IRVREG*)0ull, LABEL$1, 0ll );
		(*(tmp$55*)((uint8*)&IR$ + 272ll))( VR$1 );
		(*(tmp$44*)((uint8*)&IR$ + 128ll))( LABEL$1 );
	}
	label$33:;
	label$32:;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$34:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), (char*)((uint8*)&ENV$ + 632ll), SYM$1 );
	fb$result$1 = vr$3;
	label$35:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$46:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), (char*)((uint8*)&ENV$ + 632ll) );
	fb$result$1 = vr$3;
	label$47:;
	return fb$result$1;
}
