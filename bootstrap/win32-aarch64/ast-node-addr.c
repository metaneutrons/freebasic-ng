...
struct $6IRVREG* ASTLOADOFFSET( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$8 = (*(tmp$74*)((uint8*)&IR$ + 496ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), SYM$1, *(int64*)((uint8*)N$1 + 40ll) );
		VR$1 = vr$8;
	}
	label$25:;
	label$24:;
...
struct $7ASTNODE* ASTNEWADDROF( struct $7ASTNODE* L$1 )
{
	...
	N$1 = (struct $7ASTNODE*)0ull;
	{
		...
		TMP$88$2 = *($13AST_NODECLASS*)T$1;
		if( TMP$88$2 != 20ll) goto label$51;
		label$52:;
		{
		...
		goto label$50;
		label$51:;
		if( TMP$88$2 != 19ll) goto label$59;
		label$60:;
		{
		...
		goto label$50;
		label$59:;
		if( TMP$88$2 != 17ll) goto label$67;
		label$68:;
		{
		...
		goto label$50;
		label$67:;
		if( TMP$88$2 != 18ll) goto label$73;
		label$74:;
		{
...
struct $6IRVREG* ASTLOADADDROF( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll) goto label$92;
	{
		...
		goto label$98;
		label$94:;
		TMP$90$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$98:;
		if( (((int64)-(*(int64*)V1$1 != 4ll) | (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$89$2 * 56ll)) != 0ll)) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 616ll))) == 0ll) goto label$96;
		{
			struct $6IRVREG* vr$21 = (*(tmp$71*)((uint8*)&IR$ + 448ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$21;
			(*(tmp$54*)((uint8*)&IR$ + 240ll))( 22ll, V1$1, VR$1 );
		}
		goto label$95;
		label$96:;
		{
...
static void HREMOVENULLPTRCHECK( struct $7ASTNODE* L$1 )
{
	...
	label$30:;
	{
		...
		TMP$86$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$86$2 != 32ll) goto label$33;
		label$34:;
		{
		...
		label$36:;
		{
			label$37:;
			{
				...
				{
					$13AST_NODECLASS TMP$87$5;
					TMP$87$5 = *($13AST_NODECLASS*)T$1;
					if( TMP$87$5 != 32ll) goto label$41;
					label$42:;
					{
