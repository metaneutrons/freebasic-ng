...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		*(uint64*)((uint8*)&PARSER$ + 192ll) = 1ull;
		struct $7ASTNODE* vr$10 = ASTNEWDBG( 114ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), *(char**)((uint8*)&ENV$ + 896ll) );
		ASTADD( vr$10 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0ll );
...
static void HEMITCURRENTLINETEXT( void )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull) goto label$19;
	{
		if( *(int64*)N$1 != 30ll) goto label$21;
		{
			...
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(char**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 25080ll) );
