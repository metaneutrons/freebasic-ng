...
char* HHEXUINT( uint64 VALUE$1 )
{
	...
	static struct $8FBARRAY1Iu7INTEGERE tmp$95$1 = { (int64*)HEXTB$1, (int64*)HEXTB$1, 128ll, 8ll, 1ll, 49ll, { { 16ll, 0ll, 15ll } } };
	MAXLEN$1 = 4ll;
...
FBSTRING* HFLOATTOHEX( double VALUE$1, int64 DTYPE$1 )
{
	...
	label$24:;
	if( TMP$110$1 != 16ll) goto label$23;
	{
...
FBSTRING* HFLOATTOHEX_C99( double VALUE$1 )
{
	...
	FBSTRING* vr$37 = fb_StrConcat( &TMP$118$1, (void*)TMP$117$1, 0ll, (void*)vr$34, -1ll );
	__builtin_memset( &TMP$119$1, 0, 24ll );
	FBSTRING* vr$40 = fb_StrConcat( &TMP$119$1, (void*)"p", 2ll, (void*)vr$37, -1ll );
	__builtin_memset( &TMP$120$1, 0, 24ll );
	FBSTRING* vr$44 = fb_StrConcat( &TMP$120$1, (void*)&RET$1, -1ll, (void*)vr$40, -1ll );
...
int64 HFBRELOP2IRRELOP( int64 TK$1 )
{
	...
	static int64 OP$1;
	{
		...
		if( (TMP$121$2 - 299ull) > 5ull ) goto label$49;
		goto *tmp$122[TMP$121$2 - 299ull];
		label$41:;
	}
	fb$result$1 = OP$1;
	label$40:;
...
int64 HFILEEXISTS( char* FILENAME$1 )
{
	...
	if( (int64)vr$5 != 0ll) goto label$53;
	{
		...
		void* vr$10 = fb_ErrorThrowAt( 161, (char*)"hlp.bas", (void*)0ull, (void*)0ull );
		goto *vr$10;
		label$54:;
	}
	goto label$52;
	...
	{
		{
			...
			goto label$70;
			label$71:;
			static const void* tmp$125[123ll] = {
				&&label$72,
				&&label$74,
				&&label$74,
				&&label$74,
			...
			if( TMP$124$3 > 122ull ) goto label$74;
			goto *tmp$125[TMP$124$3 - 0ull];
			label$70:;
		}
		P$1 = (char*)((uint8*)P$1 + 1ll);
	}
...
FBSTRING* HSTRIPPATH( char* FILENAME$1 )
{
	...
	static int64 P$1[2];
	static struct $8FBARRAY1Iu7INTEGERE tmp$129$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$91:;
	{
...
FBSTRING* HSTRIPFILENAME( char* FILENAME$1 )
{
	...
	static int64 P_FOUND$1;
	static int64 P$1[2];
	static struct $8FBARRAY1Iu7INTEGERE tmp$130$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$102:;
	{
		FBSTRING* vr$1 = fb_StrAllocTempDescZEx( (char*)"\x5C", 1ll );
...
FBSTRING* HGETFILEEXT( char* FNAME$1 )
{
	...
	label$119:;
	{
		...
		{
			if( ((int64)-((uint64)(int64)*(uint8*)*(char**)&RES$1 == 92ull) | (int64)-((uint64)(int64)*(uint8*)*(char**)&RES$1 == 47ull)) == 0ll) goto label$124;
			{
				fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)"", 1ll, 0 );
			}
			goto label$123;
...
void HREPLACESLASH( char* S$1, int64 CHAR$1 )
{
	label$125:;
	{
		...
		label$130:;
		{
			if( ((int64)-((int64)(uint8)*(char*)((uint8*)S$1 + I$2) == 92ll) | (int64)-((int64)(uint8)*(char*)((uint8*)S$1 + I$2) == 47ll)) == 0ll) goto label$132;
			{
		...
		I$2 = I$2 + 1ll;
		label$127:;
		if( I$2 <= TMP$131$2) goto label$130;
		label$129:;
	}
	label$126:;
}
...
FBSTRING* PATHSTRIPDIV( FBSTRING* PATH$1 )
{
	...
	if( LENGTH$1 <= 0ll) goto label$136;
	{
		...
		{
			uint8 TMP$132$3;
			TMP$132$3 = *(uint8*)((uint8*)*(char**)PATH$1 + LENGTH$1);
			if( (uint64)(int64)TMP$132$3 == 47ull) goto label$139;
			label$140:;
			if( (uint64)(int64)TMP$132$3 != 92ull) goto label$138;
			label$139:;
			{
...
int64 PATHISABSOLUTE( char* PATH$1 )
{
	...
	if( (int64)*(uint8*)PATH$1 == 0ll) goto label$144;
	{
		{
			uint8 TMP$133$3;
			TMP$133$3 = *(uint8*)((uint8*)PATH$1 + 1ll);
			if( (uint64)(int64)TMP$133$3 != 58ull) goto label$146;
			label$147:;
			{
				fb$result$1 = -1ll;
			}
			goto label$145;
			label$146:;
			if( (uint64)(int64)TMP$133$3 != 92ull) goto label$148;
			label$149:;
			{
	...
	if( (int64)vr$5 != 0ll) goto label$153;
	{
		...
		label$154:;
		{
			...
			label$164:;
			{
				...
				void* vr$21 = fb_ErrorThrowAt( 425, (char*)"hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$21;
				label$165:;
			}
			goto label$162;
			...
			label$167:;
			{
				...
				void* vr$25 = fb_ErrorThrowAt( 428, (char*)"hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$25;
				label$168:;
			}
			goto label$162;
			...
			label$170:;
			{
				...
				void* vr$29 = fb_ErrorThrowAt( 432, (char*)"hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$29;
				label$172:;
			}
			label$169:;
...
FBSTRING* HCURDIR( void )
{
	...
	fb_StrAssign( (void*)&TMP$135$1, -1ll, (void*)vr$2, -1ll, 0 );
	FBSTRING* vr$5 = PATHSTRIPDIV( &TMP$135$1 );
...
FBSTRING* PATHSTRIPCURDIR( FBSTRING* PATH$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$136$1, (void*)vr$1, -1ll, (void*)"\x5C", 2ll );
...
int64 HISVALIDSYMBOLNAME( char* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$179:;
	if( SYM$1 != (char*)0ull) goto label$182;
	{
		goto label$180;
		label$182:;
	}
	...
	if( (uint64)(int64)(uint8)*SYM$1 < 97ull) goto label$185;
	TMP$139$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 <= 122ull);
	goto label$203;
	label$185:;
	TMP$139$1 = 0ll;
	label$203:;
	if( TMP$139$1 != 0ll) goto label$187;
	if( (uint64)(int64)(uint8)*SYM$1 > 90ull) goto label$186;
	TMP$141$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 >= 65ull);
	goto label$205;
	label$186:;
	TMP$141$1 = 0ll;
	label$205:;
	TMP$142$1 = (int64)-(TMP$141$1 != 0ll);
	goto label$204;
	label$187:;
	TMP$142$1 = -1ll;
	label$204:;
	if( TMP$142$1 != 0ll) goto label$188;
	TMP$144$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 == 95ull);
	goto label$206;
	label$188:;
	TMP$144$1 = -1ll;
	label$206:;
	if( TMP$144$1 != 0ll) goto label$190;
	{
		goto label$180;
		label$190:;
	}
	{
		...
		label$194:;
		{
			...
			int64 TMP$150$3;
			int64 TMP$151$3;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) < 97ull) goto label$195;
			TMP$146$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) <= 122ull);
			goto label$207;
			label$195:;
			TMP$146$3 = 0ll;
			label$207:;
			if( TMP$146$3 != 0ll) goto label$197;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) > 90ull) goto label$196;
			TMP$147$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) >= 65ull);
			goto label$209;
			label$196:;
			TMP$147$3 = 0ll;
			label$209:;
			...
			TMP$149$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) == 95ull);
			goto label$210;
			label$198:;
			TMP$149$3 = -1ll;
			label$210:;
			if( TMP$149$3 != 0ll) goto label$200;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) > 57ull) goto label$199;
			TMP$150$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) >= 48ull);
			goto label$212;
			label$199:;
			TMP$150$3 = 0ll;
			label$212:;
			TMP$151$3 = (int64)-(TMP$150$3 != 0ll);
			goto label$211;
			label$200:;
			TMP$151$3 = -1ll;
			label$211:;
			if( TMP$151$3 != 0ll) goto label$202;
			{
				goto label$180;
				label$202:;
			}
		...
		I$2 = I$2 + 1ll;
		label$191:;
		if( I$2 <= TMP$145$2) goto label$194;
		label$193:;
	}
	fb$result$1 = -1ll;
	label$180:;
...
static int64 HFINDEXTBEGIN( FBSTRING* PATH$1 )
{
	...
	label$75:;
	{
		...
		label$80:;
		{
			{
				uint8 TMP$126$4;
				TMP$126$4 = *(uint8*)((uint8*)*(char**)PATH$1 + I$2);
				if( (uint64)(int64)TMP$126$4 != 46ull) goto label$82;
				label$83:;
				{
					fb$result$1 = I$2;
					goto label$76;
				...
				goto label$81;
				label$82:;
				if( (uint64)(int64)TMP$126$4 == 92ull) goto label$85;
				label$86:;
				if( (uint64)(int64)TMP$126$4 != 47ull) goto label$84;
				label$85:;
				{
					goto label$79;
				}
