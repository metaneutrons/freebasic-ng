...
int64 ASTGOSUBADDRETURN( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* L$1 )
{
	...
	if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 4ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 416ll) == 0ll)) == 0ll) goto label$27;
	{
		...
		if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll) goto label$31;
		{
			...
			RTLERRORTHROW( vr$24, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), (char*)((uint8*)&ENV$ + 632ll) );
		}
		label$31:;
		label$30:;
		fb$result$1 = -1ll;
	...
	label$27:;
	{
		...
		label$33:;
		{
			...
			if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll) goto label$35;
			{
				...
				RTLERRORTHROW( vr$44, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), (char*)((uint8*)&ENV$ + 632ll) );
			}
			label$35:;
			label$34:;
			fb$result$1 = -1ll;
